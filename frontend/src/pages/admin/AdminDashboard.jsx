...
const AdminDashboard = () => {
  ...
  // [BARU] EDIT CHALLENGE STATE
  const [editingChallenge, setEditingChallenge] = useState(null); // Menyimpan object challenge yang sedang diedit
  ...
  // [MODIFIKASI] Hapus Challenge
  const handleDeleteChallenge = async (id, e) => { 
      e.stopPropagation(); // Agar tidak membuka modal edit
            ...
            <div style={{ display: 'grid', gridTemplateColumns: window.innerWidth < 1024 ? '1fr' : '1fr 1.5fr', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    {challenges.map(c => (
                        <Card 
                            key={c.id} 
                            // [MODIFIKASI] Klik Card untuk Edit
